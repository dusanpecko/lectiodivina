...
export default function Footer() {
  ...
  return (
    <footer className="relative z-20" style={{ background: 'linear-gradient(to bottom right, #1f2937, #111827, #1f2937)' }}>
      {/* Subtle background decoration - hidden from accessibility tree */}
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-300 text-sm">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <a href="tel:+421903982982" className="text-gray-300 hover:text-[#40467b] transition-colors duration-200">
                    +421 903 982 982
                  </a>
                </div>
