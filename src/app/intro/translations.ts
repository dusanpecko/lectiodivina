export const translations = {
  sk: {
    ...
    cz: {
        heroTitle: "Naslouchej tomu, co Ti chce říct Bůh",
        heroSubtitle: "Objev modlitbu Lectio Divina",
        heroDescription:
            "Ve světě plném slov, ale prázdném naslouchání, je stále těžší najít ticho. A přece – právě v tichu zaznívá Boží hlas.",
        startLectio: "Začni s Lectio Divina",
        whatIs: "Co je Lectio Divina?",
        whatIsText1:
            "Lectio Divina je starobylá forma modlitby s Písmem – ale nečekej výklad ani analýzu. Není to přednáška. Není to výkon. Je to setkání – tiché, osobní, skutečné. Skrze Boží slovo vstupujeme do rozhovoru s Tím, kdo nás zná do hloubky.",
        whatIsText2:
            "Tato forma vznikla v prvotních klášterech a později ji rozvíjeli lidé jako sv. Benedikt, Órigenés, sv. Řehoř z Nyssy nebo kartuzián Guigo II. Dnes ji znovu objevují lidé všech věků, kteří touží po vztahu s Bohem – i mimo klášterní zdi.",
        ...
        benefitsText:
            "Pravidelná praxe Lectio Divina přináší pokoj, jasnost a duchovní růst. Tisíce křesťanů po celém světě objevily proměňující sílu této modlitby.",
        howToTitle: "Lectio Divina je pro každého",
        howToText:
            "Nepotřebuješ žádné zvláštní znalosti. Stačí otevřít srdce, vybrat si text a začít prvním krokem. O zbytek se postará Bůh.",
        startFirstStep: "Začít prvním krokem",
        closingQuote:
            '"Slovo, které k Tobě dnes přichází, Tě hledá. Otevři srdce. Nech se najít."',
        closingText:
            "Lectio Divina není jen starobylá metoda – je to živá cesta pro dnešního člověka. Boží slovo, které se dnes dotkne Tvého srdce, může proměnit celý Tvůj den… a možná i celý Tvůj život.",
        ...
        steps: [
            ...
            description: "Pomalé, soustředěné naslouchání Božímu hlasu skrze Písmo.",
            duration: "10 min"
            },
            {
            number: 2,
            ...
            description: "Spočinutí v Boží přítomnosti beze slov.",
            duration: "20 min"
            },
            {
            number: 5,
            slug: "actio",
            title: "Actio – Akce – čin",
            subtitle: "Žít podle Božího slova",
            description: "Praktické uvedení do každodenního života.",
            duration: "5 min"
            }
        ],
        ...
        benefits: [
            ...
            description:
                "V tichu Lectio Divina se učíme rozpoznávat Boží hlas a otevírat mu své srdce."
            },
            {
            title: "Proměna srdce",
            description:
            ...
            description:
                "V uspěchaném světě nachází duše odpočinek v tichém setkání s Bohem."
            },
            {
            title: "Pro každého a všude",
            description:
                "Můžeš ji praktikovat sám i ve společenství – není třeba teologická příprava."
            }
        ],
        ...
        guide: [
            ...
            description:
                "Nemusíš číst celé kapitoly. Stačí pár veršů z evangelia nebo žalmů."
            },
            {
            ...
            title: "Nespěchej",
            description:
                "Lectio Divina není o rychlosti ani výkonu. Bůh se přizpůsobí Tvému tempu."
            }
        ]
    },
    ...
    en: {
        ...
        steps: [
            ...
            description: "Slow, focused listening to the voice of God through Scripture.",
            duration: "10 min"
            },
            {
            number: 2,
        ...
        es: {
            ...
            startFirstStep: "Comenzar el primer paso",
            closingQuote:
            ...
            steps: [
                ...
                subtitle: "Lectura atenta de la Palabra de Dios",
                description: "Escuchar con calma y atención la voz de Dios a través de la Escritura.",
                duration: "10 min"
                },
                {
                number: 2,
                ...
                subtitle: "Reflexión profunda sobre el texto",
                description: "Dejar que la Palabra pase de la mente al corazón.",
                duration: "15 min"
                },
                {
                number: 3,
                ...
                subtitle: "Diálogo con Dios",
                description: "Un diálogo sincero con Dios basado en su Palabra.",
                duration: "10 min"
                },
                {
                number: 4,
                ...
                description: "Reposar en la presencia de Dios sin palabras.",
                duration: "20 min"
                },
                {
                number: 5,
                slug: "actio",
                title: "Actio – Acción",
                subtitle: "Vivir según la Palabra de Dios",
                description: "Aplicar la Palabra en la vida diaria.",
                duration: "5 min"
                }
            ],
