...
const lectioIcons = [
  // LECTIO - Enhanced with better styling
  <div key="lectio" className="relative">
    ...
    <svg
      ...
      className="relative w-16 h-16 text-blue-600 mb-3 drop-shadow-lg"
      viewBox="0 0 512 512"
      fill="currentColor"
    >
  ...
  <div key="oratio" className="relative">
    ...
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 64 64"
      className="relative w-16 h-16 text-emerald-600 mb-3 drop-shadow-lg"
      fill="currentColor"
    >
  ...
  <div key="contemplatio" className="relative">
    ...
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 48 48"
      className="relative w-16 h-16 text-orange-600 mb-3 drop-shadow-lg"
      fill="currentColor"
    >
      <path d="M40,16.025V11a7.008,7.008,0,0,0-7-7H15a7.008,7.008,0,0,0-7,7v5.025a5.5,5.5,0,0,0-3,9.716V35a5,5,0,0,0,3,4.576V42a2,2,0,0,0,2,2h2a2,2,0,0,0,2-2V40H34v2a2,2,0,0,0,2,2h2a2,2,0,0,0,2-2V39.576A5,5,0,0,0,43,35V25.741a5.5,5.5,0,0,0-3-9.716Z"/>
    </svg>
  </div>
];
              ...
              {[
                ...
                >
                  <div className="text-3xl sm:text-5xl font-bold text-white mb-2 font-mono">
                    {isClient ? item.value.toString().padStart(2, '0') : '--'}
                  </div>
