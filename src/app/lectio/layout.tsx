...
export default function LectioLayout({ children }: LectioLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      {/* Kontextová hlavička pre Lectio Divina */}
      <div className="bg-white/60 backdrop-blur-sm border-b border-gray-200 relative z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Lectio Divina info */}
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-blue-600 rounded-xl flex items-center justify-center text-white shadow-lg">
                <BookOpen size={24} />
              </div>
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Duchovné čítanie a rozjímanie nad Božím slovom
                </p>
              </div>
            </div>
