          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Blokový editor pre články a novinky</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition flex items-center justify-center gap-2 text-sm"
              >
                <Grid size={16} />
                Správa kategórií
              </button>
