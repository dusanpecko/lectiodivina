...
import { 
  ...
  X, CheckCircle, AlertCircle, Crown, Star, Sun, Sparkles, Copy
} from "lucide-react";
...
export default function RosaryAdminPage() {
    ...
    reader.onload = async (evt) => {
      try {
        ...
        const newItems = json.map(row => ({
          ...
          poradie: parseInt(row.poradie) || 0,
  ...
  }, [copyDialog.ruzenec, createNewRuzenec, supabase, showNotification, filterLang, fetchRuzence]);
  ...
  }, [copyDialog.ruzenec, createNewRuzenec, supabase, showNotification, page, router]);
