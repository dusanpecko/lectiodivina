...
import { voiceTranslations } from "@/app/components/translations";
import { 
...
export default function RosaryEditPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage(error?.message || rt.messages.error);
      setMessageType("error");
    } finally {
      setSaving(false);
    }
        ...
        <form ref={formRef} onSubmit={handleSave} className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-xl p-6 border border-gray-100">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-bold" style={{ color: '#40467b' }}>{rt.content.title}</h2>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-800">{rt.media.title}</h2>
            </div>
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
                <div className="flex items-center mb-4">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-800">{rt.settings.title}</h2>
            </div>
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
