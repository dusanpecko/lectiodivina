...
export default function NewProductPage() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    ...
    // Auto-generate slug from SK name
    if (name === 'name_sk' && !formData.slug) {
      const slug = value
        .toLowerCase()
        .normalize('NFD')
        .replace(/[\u0300-\u036f]/g, '')
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.error) {
        ...
        alert('Produkt bol úspešne vytvorený!');
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Nový produkt</h1>
          <p className="text-gray-600 mt-1">Pridajte nový produkt do e-shopu</p>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                placeholder="Lectio Divina Žurnál"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Lectio Divina Journal"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Lectio Divina Deník"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Diario de Lectio Divina"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="lectio-divina-zurnal"
            />
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="Krásny žurnál pre vaše duchovné poznámky..."
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="Beautiful journal for your spiritual notes..."
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="Krásný deník pro vaše duchovní poznámky..."
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="Hermoso diario para tus notas espirituales..."
            />
          </div>
        </div>
