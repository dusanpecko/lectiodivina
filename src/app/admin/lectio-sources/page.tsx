...
export default function LectioSourcesAdminPage() {
  ...
  const stats = useMemo(() => {
    ...
    return {
      ...
      withAudio: lectioSources.filter(l => l.lectio_audio).length,
      thisMonth: lectioSources.filter(l => l.created_at?.startsWith(thisMonth)).length,
      language: filterLang.toUpperCase(),
    };
  }, [lectioSources, filterLang]);
